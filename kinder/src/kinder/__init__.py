...
def register_all_environments() -> None:
    ...
    # PushPullHook2D-GraspVertical environment (curriculum variant)
    variant_id = "kinder/PushPullHook2D-GraspVertical-v0"
    _register(
        id=variant_id,
        entry_point="kinder.envs.geom2d.pushpullhook2d_grasp_vertical:PushPullHook2DGraspVerticalEnv",  # pylint: disable=line-too-long
    )
    _register_env_class(
        class_name="PushPullHook2D-GraspVertical",
        entry_point="kinder.envs.geom2d.pushpullhook2d_grasp_vertical:PushPullHook2DGraspVerticalEnv",  # pylint: disable=line-too-long
        category="Geom2D",
        variant_ids=[variant_id],
    )
    ...
    # PushPullHook2D-GraspTouch environment (curriculum variant)
    variant_id = "kinder/PushPullHook2D-GraspTouch-v0"
    _register(
        id=variant_id,
        entry_point="kinder.envs.geom2d.pushpullhook2d_grasp_touch:PushPullHook2DGraspTouchEnv",  # pylint: disable=line-too-long
    )
    _register_env_class(
        class_name="PushPullHook2D-GraspTouch",
        entry_point="kinder.envs.geom2d.pushpullhook2d_grasp_touch:PushPullHook2DGraspTouchEnv",  # pylint: disable=line-too-long
        category="Geom2D",
        variant_ids=[variant_id],
    )
