...
import numpy as np
from structs import LiftedParameterizedController
...
# Controllers.
class GroundPickStickController(Kinematic2dRobotController):
...
class GroundPlaceStickController(Kinematic2dRobotController):
...
class GroundRobotPressButtonController(Kinematic2dRobotController):
...
class GroundStickPressButtonController(Kinematic2dRobotController):
